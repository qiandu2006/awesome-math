...
经典 Morse 理论（Milnor 1963）通过光滑函数的临界点分析流形拓扑。Floer（1988）将 Morse 理论推广到无穷维情形：在 Lagrange 子流形的交点（辛 Floer 同调）或 3-流形上的平坦联络（瞬子 Floer 同调）处，通过解模空间的紧性问题定义链复形，其同调成为强力的拓扑不变量。
