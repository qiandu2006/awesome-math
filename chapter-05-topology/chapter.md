...
![](../images/Pasted%20image%2020260627001011.png)
...
把咖啡杯和甜甜圈理想化为带一个把手的二维曲面后，它们可以通过连续且可逆的变形对应起来，而不需要撕裂或粘合。严格说，这种“拓扑上相同”叫同胚；如果只讨论路径或映射能否连续变形到另一条路径或映射，则叫同伦。这里比较的是理想化的表面，不是两个日常物体的材质、厚度或内部结构。
